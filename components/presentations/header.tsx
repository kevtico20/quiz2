...
export default function Header({ cart, dispatch }: HeaderProps) {
  ...
  const handleBuyClick = () => {
    ...
    setTimeout(() => {
      ...
      setDisabledBuyButton(false); // Habilitar el botón de comprar después de mostrar la pantalla flotante
    }, 2000); // Espera 2 segundos antes de mostrar la pantalla flotante
  };
